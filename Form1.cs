...
namespace FormApp
{
	public partial class Form1 : Form
	{
		...
		private void özelFormatExcelKayýtToolStripMenuItem_Click(object sender, EventArgs e)
		{
			OzelFormatExcelKayit ozelFormatExcelKayit = new OzelFormatExcelKayit();
			ozelFormatExcelKayit.MdiParent = this;
			ozelFormatExcelKayit.Show();
		}
	}
}
